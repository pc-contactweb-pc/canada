        ...
        <footer class="pc-footer bg-hg">
            <section class="container">
                ...
                <div class="mrgn-tp-lg">
                    <h3><a href="#noTarget" class="wb-lbx">Contact Parks Canada</a></h3>
                </div>
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <ul class="list-unstyled lst-spcd colcount-sm-2">
                            ...
                            <!-- split to col 2 -->
                            <li><a href="#noTarget" class="wb-lbx">National historic sites</a></li>
                            <li><a href="#noTarget" class="wb-lbx">National parks</a></li>
            ...
            <div class="brand">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-2 text-right"> <img src="https://www.canada.ca/etc/designs/canada/cdts/gcweb/v4_0_32/assets/wmms-blk.svg" alt="Symbol of the Government of Canada" />
